...
public class ItemDatabaseManger : MonoBehaviour
{
    private static ItemDatabaseManger _instance;
    public static ItemDatabaseManger Instance
    {
        get
        {
            if(_instance == null) _instance = FindObjectOfType<ItemDatabaseManger>();
            return _instance;
        }
    }
