...
namespace Alpha.Player.Combat
{
    ...
    public sealed class MeleeSkillAttackSettings
    {
        ...
        [Tooltip("Melee Combat의 기본 공격력에 곱할 Skill 배율입니다.")]
        [SerializeField, Min(0f)]
    ...
    // Player 근접 Combat이 사용할 공격·연출 데이터를 하나의 자산으로 보관한다.
    [CreateAssetMenu(
        fileName = "MeleeSkill",
    ...
    public sealed class MeleeSkillDefinition : ScriptableObject
    {
        ...
        [Tooltip("명중 시 재생할 Camera Shake 설정 이름입니다. 비어 있으면 재생하지 않습니다.")]
        [SerializeField]
        private string _cameraShakeName;
        ...
        public string CameraShakeName => _cameraShakeName?.Trim();
        ...
        private void OnValidate()
        {
            ...
            _cameraShakeName = _cameraShakeName?.Trim();
