...
{
    internal enum EMeleeCombatResult
    {
        Running,
        Completed
    }
    ...
    internal sealed class MeleeCombatFlow
    {
        private readonly MeleeComboFlow _comboFlow = new();
        private readonly MeleeSkillFlow _skillFlow = new();

        private MeleeComboDefinition _comboDefinition;
        private MeleeAttackModule _attackModule;
        ...
        public bool Bind(
            ...
            MeleeAttackModule p_attackModule,
        ...
        public EMeleeCombatResult TickAction(
            EWeaponActionType p_type,
            bool p_isInputHeld,
            ...
            float p_deltaTime)
        {
            if (p_type != EWeaponActionType.Primary ||
                CurrentSkill == null)
            {
                return EMeleeCombatResult.Running;
            }
            ...
            switch (result)
            {
                case EMeleeComboFlowResult.SkillChanged:
                    ...
                    _comboFlow.Cancel();
                    return EMeleeCombatResult.Completed;
