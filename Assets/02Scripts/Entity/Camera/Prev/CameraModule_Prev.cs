...
using UnityEngine.InputSystem.HID;
    ...
    public class CameraModule_Prev : MonoBehaviour
    {
        ...
        [Header("[View Data]")]
        [SerializeField] private CameraViewDataSO _tpsViewData;
        [SerializeField] private CameraViewDataSO _aimViewData;
        [SerializeField] private CameraViewDataSO _quarterViewData;
        ...
        #region ==================== Runtime
        [Header("[View Type]")]
        [SerializeField] private ECameraViewType _currentViewType;
        private CameraViewDataSO _currentViewData
        {
            get
            {
                return _currentViewType switch
                {
                    ECameraViewType.ThirdPerson => _tpsViewData,
                    ECameraViewType.Aim => _aimViewData,
                    ECameraViewType.Quarter => _quarterViewData,
                    _ => _tpsViewData
                };
            }
        }
        ...
        private void Start()
        {
            ...
            _currentViewType = ECameraViewType.Quarter;
        ...
        private void Update()
        {
            ...
            {
                SetView(ECameraViewType.Aim);
            }
            else if(Input.GetKeyDown(KeyCode.Alpha0))
            {
                SetView(ECameraViewType.Quarter);
            }
        ...
        private void LateUpdate()
        {
            ...
            if (_currentViewType == ECameraViewType.Quarter)
                TopViewFollow();
            else
                TPSFollow();
        }

        public void SetView(ECameraViewType p_viewType)
        {
        ...
        public void RigFollw()
        {
            ...
            if (_currentViewType == ECameraViewType.ThirdPerson)
        ...
        {
            if (_currentViewType != ECameraViewType.ThirdPerson) return;
